...
background_image = pygame.image.load("nightBackground.jpg").convert()
player_image = pygame.image.load("tux.png").convert()
player_image.set_colorkey(WHITE) #makes player background transparent
